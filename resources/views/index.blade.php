...
@section('hero')
        <div id="content" class='text-center'>
            @foreach($recipes as $recipe)
                <div class="card mt-2 col-md-3 d-inline-block">
                  <div class="row no-gutters">

                    <div class="col-md-4 ml-3 mb-3 mt-3 p-2 bg-light rounded">
                        ...
                        <div class="card-body text-left">
                            ...
                            @if($recipe->m1_val > 0)
                                <a href="/material/{{ $recipe->m1_id }}">
                                    <div class="w-48 p-1 mb-1 bg-light rounded mat">
                  ...
                  <div class="card-footer text-muted">
                      <div class="row">
                          ...
                          <div class="col-sm text-right align-middle">
                              <a href="/category/{{ $recipe->category }}"><button class="btn btn-light text-right">{{ $recipe->category }}</button></a>
                          </div>
                      </div>
                  </div>
