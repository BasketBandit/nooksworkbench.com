                  ...
                  <div class="row no-gutters h-100">
                    <div class="card-img-wrap col-md-4 p-2">
                      <a href="/recipe/{{ rawurlencode(strtolower($recipe->name)) }}">
                          <picture>
                              <source type="image/webp" srcset="http://localhost/crafting/{{ $recipe->image }}.webp">
                            ...
                            @if($recipe->m1_val > 0)
                                <a href="/material/{{ rawurlencode(strtolower($recipe->m1_id)) }}">
                                    <div class="mat rounded w-100 p-1 mb-1">
                                        <div class="mat-img">
                                            <picture>
                                                <source type="image/webp" srcset="{{ asset('/i/inventory/'.rawurlencode($recipe->m1_id).'.webp') }}">
                                                <img src="{{ asset('/i/inventory/'.rawurlencode($recipe->m1_id).'.png') }}" alt="{{ $recipe->m1_id }}">
                                            </picture>
                                        </div>
                            ...
                            @if($recipe->m2_val > 0)
                                <a href="/material/{{ rawurlencode(strtolower($recipe->m2_id)) }}">
                                    <div class="mat rounded w-100 p-1 mb-1">
                                        <div class="mat-img">
                                            <picture>
                                                <source type="image/webp" srcset="{{ asset('/i/inventory/'.rawurlencode($recipe->m2_id).'.webp') }}">
                                                <img src="{{ asset('/i/inventory/'.rawurlencode($recipe->m2_id).'.png') }}" alt="{{ $recipe->m2_id }}">
                                            </picture>
                                        </div>
                            ...
                            @if($recipe->m3_val > 0)
                                <a href="/material/{{ rawurlencode(strtolower($recipe->m3_id)) }}">
                                    <div class="mat rounded w-100 p-1 mb-1">
                                        <div class="mat-img">
                                            <picture>
                                                <source type="image/webp" srcset="{{ asset('/i/inventory/'.rawurlencode($recipe->m3_id).'.webp') }}">
                                                <img src="{{ asset('/i/inventory/'.rawurlencode($recipe->m3_id).'.png') }}" alt="{{ $recipe->m3_id }}">
                                            </picture>
                                        </div>
                            ...
                            @if($recipe->m4_val > 0)
                                <a href="/material/{{ rawurlencode(strtolower($recipe->m4_id)) }}">
                                    <div class="mat rounded w-100 p-1 mb-1">
                                        <div class="mat-img">
                                            <picture>
                                                <source type="image/webp" srcset="{{ asset('/i/inventory/'.rawurlencode($recipe->m4_id).'.webp') }}">
                                                <img src="{{ asset('/i/inventory/'.rawurlencode($recipe->m4_id).'.png') }}" alt="{{ $recipe->m4_id }}">
                                            </picture>
                                        </div>
                            ...
                            @if($recipe->m5_val > 0)
                                <a href="/material/{{ rawurlencode(strtolower($recipe->m5_id)) }}">
                                    <div class="mat rounded w-100 p-1 mb-1">
                                        <div class="mat-img">
                                            <picture>
                                                <source type="image/webp" srcset="{{ asset('/i/inventory/'.rawurlencode($recipe->m5_id).'.webp') }}">
                                                <img src="{{ asset('/i/inventory/'.rawurlencode($recipe->m5_id).'.png') }}" alt="{{ $recipe->m5_id }}">
                                            </picture>
                                        </div>
                            ...
                            @if($recipe->m6_val > 0)
                                <a href="/material/{{ rawurlencode(strtolower($recipe->m6_id)) }}">
                                    <div class="mat rounded w-100 p-1 mb-1">
                                        <div class="mat-img">
                                            <picture>
                                                <source type="image/webp" srcset="{{ asset('/i/inventory/'.rawurlencode($recipe->m6_id).'.webp') }}">
                                                <img src="{{ asset('/i/inventory/'.rawurlencode($recipe->m6_id).'.png') }}" alt="{{ $recipe->m6_id }}">
                                            </picture>
                                        </div>
                      ...
                      <div class="row">
                          @if($recipe->grid)
                              <div class="col-sm text-left">
                                  <a href="/size/{{ strtolower($recipe->grid) }}"><img class="foot-img" src="{{ asset('/i/grid/'.$recipe->grid.'.jpg') }}" alt="{{ $recipe->grid }}"/></a>
                              </div>
                          @endif
                          ...
                          @if($recipe->sell > 0)
                              <div class="col-sm text-right">
                                  <picture>
                                      <source type="image/webp" srcset="{{ asset('/i/inventory/Bells.webp') }}">
                                      <source type="image/png" srcset="{{ asset('/i/inventory/Bells.png') }}">
                                      <img class="foot-img" src="asset('/i/inventory/Bells.png')">
                                  </picture>
                                  {{ $recipe->sell }}
                              </div>
                          @endif
