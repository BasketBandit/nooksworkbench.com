<div class="container-fluid text-center bg-pgreen">
    <div class="row text-center">
        <div class="w-100">
            <p>
                <a rel="noreferrer" href="https://github.com/BasketBandit"><img class="social-btn" src="{{ secure_asset('/i/social/github.png') }}" alt="github"/></a>
                <a rel="noreferrer" href="https://www.linkedin.com/in/jmh79/"><img class="social-btn" src="{{ secure_asset('/i/social/linkedin.png') }}" alt="linkedin"/></a>
                <a rel="noreferrer" href="https://discord.gg/4Tx6G3p"><img class="social-btn" src="{{ secure_asset('/i/social/discord.png') }}" alt="discord"/></a>
            </p>
        </div>
    </div>
</div>
